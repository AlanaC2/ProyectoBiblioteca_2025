		...
		bot1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (!(isbn.length() == 10 || isbn.length() == 13)) {
					JOptionPane.showMessageDialog(null, "El ISBN debe tener 10 o 13 caracteres", "Error",
				...
				try {
					...
					int cantEjemplares = Integer.parseInt(tex5.getText().trim());
					if (cantEjemplares < 0) {
					...
					logica.registrarLibro(isbn, titulo, autor, materia, estado, demanda, cantEjemplares);
