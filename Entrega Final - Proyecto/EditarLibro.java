...
public class EditarLibro extends JFrame {
	...
	public EditarLibro(String isbn, String titulo, String autor, String materia, String estado, int cantidad,
			vtnPrincipal principal) {
		...
		bot1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					logica.modificarLibro(isbn, titulo, autor, materia, estadoFisico, cantEjemplares);
