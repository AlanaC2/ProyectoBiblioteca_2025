...
public class vtnInicioSesion extends JFrame {
    ...
    public vtnInicioSesion() {
		...
		p1.setBorder(BorderFactory.createEmptyBorder(50, 0, 0, 0)); // top, left, bottom, right
        ...
        // Campos
        JTextField txtUsuario = new PlaceholderTextField("Usuario");
        txtUsuario.setBackground(Colores.gris);
